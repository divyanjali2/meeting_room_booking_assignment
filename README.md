...
This is a web-based interface for managing meeting room bookings. Logged-in users can create, edit, and delete their own bookings, and can only view bookings made by others. Users can also filter by room and date.
...
- Edit existing bookings (**only your own bookings**).
- Delete bookings (**only your own bookings**).

### 🔍 Filters & Sorting
- Filter bookings by **room** and **date**.
- Toggle between viewing **all bookings** or **only your bookings**.
- ↕Sort bookings by **room, date, start time, or end time**.

### ⚡ Live Updates
- Bookings table refreshes **automatically every minute**.
...
- Edit or 🗑️ delete bookings you created.

- Bookings update automatically every minute.


## 📌 Notes
- Only authenticated users can book, edit, or delete bookings.

- Current implementation supports "Room A" and "Room B".
