    ...
    <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4" @click.away="cancelEdit">
        ...
        <form @submit.prevent="saveBooking" class="space-y-4">
            ...
            <div>
                ...
                <input type="time" x-model="form.start_time" class="mt-1 block w-full border px-3 py-2 rounded" required>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">End Time</label>
                <input type="time" x-model="form.end_time" class="mt-1 block w-full border px-3 py-2 rounded" required>
            </div>
